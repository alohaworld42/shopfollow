...
const features = [
    {
        ...
        description: 'Post your shopping finds and inspire friends with your style'
    },
    {
        icon: Users,
        title: 'Discover Together',
        description: 'See what your network is buying and find new products'
    },
    {
        icon: Coins,
        title: 'Earn Rewards',
        description: 'Get rewarded when friends buy through your links'
    }
];
    ...
    return (
        <div className="welcome-page">
            ...
            <div className="welcome-hero">
                ...
                <p className="welcome-subtitle">Share Your Style, Earn Together</p>
